 ...
 *                     Developed By Dave                                *
 *                                                                           *
 *  🌐  GitHub   : https://github.com/DavidXTech                         *
 *  ▶️  YouTube  : https://youtube.com/@DavidXTech                       *
 *  💬  WhatsApp : https://whatsapp.com/channel/0029VbCGhUI7T8bP7vjhfq3t     *
 *                                                                           *
 *    © 2026 DavidXTech. All rights reserved.                            *
 *                                                                           *
 *    Description: This file is part of the COLLY MD Project.                 *
...
const store = {
    ...
    try {
      if (backend !== 'memory') {
        ...
        if (fs.existsSync(filePath)) {
          ...
          this.contacts = {} // skip loading contacts in memory mode to save RAM
  ...
  bind(ev) {
    ...
    ev.on('contacts.update', async (contacts) => {
      if (backend === 'memory') return; // skip contact storage in memory mode to save RAM
