...
# Usage: bash <(curl -s https://raw.githubusercontent.com/GlobalTechInfo/MEGA-MDX/main/lib/railway.sh)
...
if [ ! -f "railway.json" ]; then
    ...
    git clone https://github.com/GlobalTechInfo/MEGA-MDX mega-md-deploy
    cd mega-md-deploy
fi
