...
async function UploadFileUgu (input: any) {
    return new Promise (async (resolve, reject) => {
            const form = new BodyForm();
...
function webp2mp4File(path: any) {
...
async function floNime(medianya: any, options = {}) {
...
export { TelegraPh, UploadFileUgu, webp2mp4File, floNime }